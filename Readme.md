...
## 📜 Credits
Original project: [BoostedBrightness by Adam Viola](https://github.com/adamviola/BoostedBrightness)  
Licensed under the **MIT License**.  
Ported and maintained by **Sarocesch (Boss Boosted Brightness: Remastered)**.

## ⚖️ License
This project retains the original MIT license.  
All modifications © 2025 Sarocesch.
